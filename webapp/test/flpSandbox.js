		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Routing",
									"targetURL": "#sapcomrouting1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcomrouting1-display": {
								"semanticObject": "sapcomrouting1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.com.routing1",
									"url": sap.ui.require.toUrl("sap/com/routing1")
								}
							}
						}
					}
